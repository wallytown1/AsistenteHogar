...
| **Chef Marce Chat** | **Máximo 5 mensajes al día** | **Mensajes ilimitados** |
| **OCR de Tickets** | No disponible | **Ilimitado** (Gemini Vision) |
| **Foto-Nevera** | No disponible | **Ilimitado** (Gemini Vision) |
...
*   **Conversión:** Al superar el mensaje 5 del día en el chat con Marce, el servidor responde con un código de estado `402 Payment Required`, que navega automáticamente en el frontend a la pantalla de pago (`PaywallScreen`).
