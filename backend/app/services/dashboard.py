...
class DashboardService:
    ...
    async def get_unified_dashboard(
        ...
        conflictos_hoy: list[ConflictoDetalle] = [
            ...
            if conf.evento_a.fecha_inicio.astimezone(UTC).date() == hoy_utc
            or conf.evento_b.fecha_inicio.astimezone(UTC).date() == hoy_utc
        ]
        ...
        tareas_pendientes: list[TareaHogarResponse] = [
            TareaHogarResponse.model_validate(tarea).model_copy(
                update={
